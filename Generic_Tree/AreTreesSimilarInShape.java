...
// Does not used for each loop as child of one tree can be more than child of another tree and hence size of children can be compared by iterating through it(BASE CASE).
